...
const PopIns = () => {
  ...
  useEffect(() => {
    fetch('https://summer-camp-server-sourov-hossain1.vercel.app/popins')
      .then(res => res.json())
      .then(data => {
        setInstractors(data)
      })
  ...
  return (
    <>
      <div className="hero h-[350px]" >
        ...
        <div className="hero-content text-center text-neutral-content text-primary">
      ...
      <div className="popins-card mt-3">
        {
          instractors.map(instractor => <div key={instractor._id} className="card single-card card-side bg-base-100 shadow-xl">
